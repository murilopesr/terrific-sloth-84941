            ...
            <div className="inner outer">
              <article className="post post-full">
                ...
                <footer className="post-meta inner-sm">
                  <time className="published" dateTime={moment(_.get(this.props, 'pageContext.frontmatter.date', null)).strftime('%d-%m-%Y %H:%M')}>{moment(_.get(this.props, 'pageContext.frontmatter.date', null)).strftime('%B %d, %Y')}</time>
                </footer>
              </article>
            </div>
            </Layout>
